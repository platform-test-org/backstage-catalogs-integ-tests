...
const EntityLatestGithubActionRunCard = githubActionsPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index-0f01aa9c.esm.js').then((m) => m.LatestWorkflowRunCard)
    }
  })
);
const EntityLatestGithubActionsForBranchCard = githubActionsPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index-0f01aa9c.esm.js').then(
...
const EntityRecentGithubActionsRunsCard = githubActionsPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index-0f01aa9c.esm.js').then((m) => m.RecentWorkflowRunsCard)
    }
  })
);
...
const WorkflowRunDetails = ({ entity }) => {
  ...
  return /* @__PURE__ */ React.createElement("div", {
    ...
    noWrap: true
  }, "Links")), /* @__PURE__ */ React.createElement(TableCell, null, ((_p = details.value) == null ? void 0 : _p.html_url) && /* @__PURE__ */ React.createElement(Link, {
    to: details.value.html_url
