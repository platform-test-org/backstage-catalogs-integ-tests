...
const EntityGroupProfileCard = orgPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index-f02f82c8.esm.js').then((m) => m.GroupProfileCard)
    }
  })
);
const EntityMembersListCard = orgPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index-f02f82c8.esm.js').then((m) => m.MembersListCard)
    }
  })
);
const EntityOwnershipCard = orgPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index-f02f82c8.esm.js').then((m) => m.OwnershipCard)
    }
  })
);
const EntityUserProfileCard = orgPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index-f02f82c8.esm.js').then((m) => m.UserProfileCard)
    }
  })
);
...
const LinksGroup = ({ links }) => {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Divider, null), links.map((link) => {
    return /* @__PURE__ */ React.createElement(WebLink, {
      key: link.url,
      href: link.url,
      text: link.title,
