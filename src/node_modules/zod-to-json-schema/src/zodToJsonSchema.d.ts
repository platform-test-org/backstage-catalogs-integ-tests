 ...
 *
 */
declare function zodToJsonSchema<Name extends string | undefined = undefined, Strategy extends "root" | "relative" | "none" | undefined = undefined, BasePath extends string[] | undefined = undefined, DefinitionPath extends "definitions" | "$defs" = "definitions", Target extends "jsonSchema7" | "openApi3" | undefined = undefined, Definitions extends Record<string, ZodSchema<any>> | undefined = undefined>(schema: ZodSchema<any>, options?: {
    name?: Name;
    ...
    $ref: string;
} & Record<DefinitionPath, Record<Name | keyof Definitions, object>> : Strategy extends "relative" ? {
    $ref: `0/${DefinitionPath}/${Name}`;
} & Record<DefinitionPath, Record<Name | keyof Definitions, object>> : {
    $ref: `#/${DefinitionPath}/${Name}`;
} & Record<DefinitionPath, Record<Name | keyof Definitions, object>> : object : Name extends string ? BasePath extends string[] ? {
    $schema: "http://json-schema.org/draft-07/schema#";
    $ref: string;
} & Record<DefinitionPath, Record<Name | keyof Definitions, JsonSchema7Type>> : Strategy extends "relative" ? {
    $schema: "http://json-schema.org/draft-07/schema#";
    $ref: `0/${DefinitionPath}/${Name}`;
} & Record<DefinitionPath, Record<Name | keyof Definitions, JsonSchema7Type>> : {
    $schema: "http://json-schema.org/draft-07/schema#";
    $ref: `#/${DefinitionPath}/${Name}`;
} & Record<DefinitionPath, Record<Name | keyof Definitions, JsonSchema7Type>> : Definitions extends undefined ? {
    $schema: "http://json-schema.org/draft-07/schema#";
} & JsonSchema7Type : {
    $schema: "http://json-schema.org/draft-07/schema#";
} & JsonSchema7Type & Record<DefinitionPath, Record<keyof Definitions, JsonSchema7Type>>;
